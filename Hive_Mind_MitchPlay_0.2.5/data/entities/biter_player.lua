...
local make_biter_player = function(name, graphics)
  ...
  player.max_health = graphics.max_health * 3
...
make_biter_player(names.players.small_biter_player, util.copy(data.raw.unit["medium-biter"]))
